...
#define _DUTY_NEU  (_DUTY_MIN+_DUTY_MAX)/2.0 // servo neutral position (90 degree)
...
#define LOOP_INTERVAL 80 // Loop Interval (unit: msec)
...
void loop()
{
  ...
  duty =  _DUTY_MIN + (dist_ema - _DIST_MIN) * (_DUTY_MAX - _DUTY_MIN) / (_DIST_MAX - _DIST_MIN);// Put map() equivalent code here
